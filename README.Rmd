...
- [ ] Implement user option to insert a taxonomic table and backbone phylogeny
    - [ ] Create two arguments to receive user phylogeny and user taxonomic database
    - [ ] Create a function to produce the taxonomic database?
    - [ ] Checking procedures for phylogeny and taxonomic database (number of species, size of the list etc.)
