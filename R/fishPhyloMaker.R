...
#' @param return.insertions Logical, if TRUE the result will return a list containing a newick and a data
#'     frame with the classification indicating at which level each species was inserted in the tree (default is FALSE)
#' @return
#' @export
#'
#' @examples
